...
void quiz()
{
	...
	int wrong=0;
	char answer;
	struct question abc[8];
	int srno=0;
	

	abc[0] = {"Which is Nepal's first highway ??","Mahendra Highway","Tribhuwan Highway","Siddhartha Highway","Araniko Highway",'b'};
	abc[1] = {"When is earthquake day celebrated in Nepal?","Baisakh 12","Baisakh 29","Magh 2","Chaitra 12",'c'};
	abc[2] = {"What is the height of Everest ?","8848m","8849m", "8086m", "8650m ",'b'};
	abc[3] = {"Which is the largest river of Nepal?","Gandaki","Koshi","Karnali","Mechi.",'b'};
	abc[4] = {"Which of the following is the largest lake of Nepal?","Phewa","Shey Phoksundo","Gosaikunda","Rara",'d'};
	abc[5]={"Who is known as The LIGHT OF ASIA","Mahatma Gandhi","Gautam Buddha","King Ashoka","King Tribhuwan",'b'};
	abc[6]={"Who invented Light Bulb","Nikola Tesla","Benjamin Franklin","Thomas Alva Edison","Archimedes",'c'};
	abc[7]={"Who was the first prime minister of Nepal?","B.P Koirala","Tanka Prasad Acharya","Ranganath Paudel","Bhimsen Thapa",'d'};
...
void write_student()
{
	student st;
	ofstream outFile;
	outFile.open("quiz.dat",ios::binary|ios::app);
	st.getdata();
...
void display_all()
{
	student st;
	ifstream inFile;
	inFile.open("quiz.dat",ios::binary);
	if(!inFile)
	{
...
{  
	...
	cout<<"\n\n\n\t\t\t\t   __      __   ___  | |   ___    ___    _ __ ___     ___  "<<endl;
			...
			cout<<"\n\n\t\t\t\t\t| 1. AMIT ACHARYA   078BEI002   \t|";
			cout<<"\n\n\t\t\t\t\t| 2. SAMYAM GIRI     078BEI035	\t|";
            cout<<"\n\n\t\t\t\t\t| 2. BIRAT THAPA    078BEI012   \t|";
            cout<<"\n\n\t\t\t\t\t| 2. ASHIM  SAPKOTA   078BEI006 \t|";
            Sleep(4000);
						setcolor(WHITE);
						system("CLS");
			cout<<"\n\n\n\t\t\t\t   __      __   ___  | |   ___    ___    _ __ ___     ___  "<<endl;
